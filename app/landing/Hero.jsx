...
import { Particles } from "@/app/landing/particles";
import { ArrowRight } from "lucide-react";

/**
 * @typedef {{ [key: string]: any }} HeroProps // This allows any props
 */

/**
 * @param {HeroProps} props - Optional props for the component
 */
        ...
        <div className="pt-32 pb-16 md:pt-52 md:pb-32">
          ...
          <div className="container mx-auto text-center">
            ...
            <h1
              ...
              data-aos="fade-down"
            >
              <ReactWrapBalancer>Zephyrus Development</ReactWrapBalancer>
            </h1>
            <p
